    ...
    return new Promise((resolve) => {
      setTimeout(() => {
        resolve({
          ...
          follow_up_recommendation: "Formal comprehensive SLP evaluation recommended within 2 weeks to perform auditory-perceptual scaling, oral-motor assessment, and diagnostic subtyping.",
